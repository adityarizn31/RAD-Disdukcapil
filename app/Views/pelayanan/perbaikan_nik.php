...
<div class="container" style="padding: 10px;">
  <div class="card shadow mb-4" style="padding: 20px;">
    <div class="container">
      ...
      <form action="/pelayanan/savePerbaikanNIK" method="post" enctype="multipart/form-data">
        ...
        <div class="row">
          <div class="mb-3">
            ...
            <input type="file" class="form-control <?= ($validation->hasError('kartutandapenduduk')) ? 'is-invalid' : ''; ?>" name="kartutandapenduduk" id="kartutandapenduduk" value="<?= old('kartutandapenduduk'); ?>" size="20">
            <div class="invalid-feedback">
        ...
        <div class="row">
          <div class="mb-3">
            ...
            <input type="file" class="form-control <?= ($validation->hasError('kartukeluarga')) ? 'is-invalid' : ''; ?>" name="kartukeluarga" id="kartukeluarga" value="<?= old('kartukeluarga'); ?>" size="20">
            <div class="invalid-feedback">
