        ...
        <div class="card card-outline card-primary">
          ...
          <div class="card-body">
            ...
            <div class="grid-container2">
              ...
              <div class="div">
                <a href="<?= base_url('/DetailAdmin/belumSelesaiKK/' . $pendaftaran_kk['id']) ?>" class="btn btn-danger" data-popup="tooltip" data-placement="top" title="Tidak Selesai"><i class="bi bi-x-square" aria-hidden="true"></i></a>
              </div>
            </div>
