...
class PelayananSilancar extends BaseController
{
  ...
  public function saveSuratPindah()
  {
    ...
    session()->setFlashdata('pesan', 'Selamat Pendaftaran Surat Perpindahan Anda Behasil !!');
  ...
  public function saveSuratPindahLuar()
  {
    ...
    session()->setFlashdata('pesan', 'Selamat Pendaftaran Surat Perpindahan Luar Anda Behasil !!');
  ...
  public function saveKeabsahanAkla()
  {
    ...
    session()->setFlashdata('pesan', 'Selamat Pendaftaran Keabsahan Akta Kelahiran Anda Berhasil !!');
  ...
  public function savePelayananData()
  {
    ...
    session()->setFlashdata('pesan', 'Selamat Pendaftaran Pelayanan Data anda Berhasil !!');
