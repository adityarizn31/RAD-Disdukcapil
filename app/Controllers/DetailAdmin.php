...
class DetailAdmin extends BaseController
{
  ...
  {
    $pendaftaran_kk_perceraian = $this->kkperceraianModel->getDataKK($namaPemohonKKPerceraian);
  ...
  public function belumSelesaiKKPerceraian($namaPemohonKKPerceraian)
  {
    ...
    session()->setFlashdata('pesan', 'Pendaftaran Gagal Di Verifikasi !!');
    return redirect()->to('/DetailAdmin/detail_pendaftarankk_admin/' . $namaPemohonKKPerceraian);
  }
  ...
  public function selesaiSuratPerpindahan($namaPemohonSuratPerpindahan)
  {
    ...
    session()->setFlashdata('pesan', 'Pendaftaran telah selesai diverifikasi !!');
  ...
  public function belumSelesaiSuratPerpindahan($namaPemohonSuratPerpindahan)
  {
    ...
    session()->setFlashdata('pesan', 'Pendaftaran gagal diverifikasi !!');
    return redirect()->to('/DetailAdmin/detail_pendaftaransuratperpindahan_admin/' . $namaPemohonSuratPerpindahan);
  }
